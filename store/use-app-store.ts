// Compatibility wrapper for gradual migration to unified chat-store
// This file maps the old useAppStore interface to the new useChatStore

import { useChatStore } from './chat-store'
import type { ChatPanel, CustomPrompt, ChatMessage, PromptUsageHistoryItem, SendMode } from '@/types'
...
// Create a wrapper that maps to the unified chat-store
export const useAppStore = () => {
  ...
  return {
    ...
    openRouterApiKey: chatStore.openRouterApiKey || chatStore.settings.apiKeys.openRouter || '',
